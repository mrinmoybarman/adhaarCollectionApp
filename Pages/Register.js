...
export default function Register({ navigation }) {
    ...
    // const [unique_device_id, setUniqueDeviceId] = useState('');

    const {register} = useContext(AuthContext);    

    const unique_device_id = Platform.constants.Fingerprint;
            ...
            <View style={styles.container}>
                ...
                <View style={{flex:0.7}}>
                    ...
                    <View style={{ marginLeft: 10, marginBottom: 5 }}>
                        <Text style={[styles.text1, { alignSelf: 'center', marginBottom: 10, color: "#000" }]}>Register Using Your NRLM ID and Mobile Number</Text>
                        <View>
                    ...
                    <View style={{ alignSelf: 'center', marginTop: 10,flexDirection:'row',justifyContent:'center',alignItems:'center' }}>
                        <TouchableOpacity style={{ backgroundColor: "blue", width: "30%", marginRight: 5 }} onPress={() =>navigation.navigate('Login')}>
                            <Text style={{ padding: 8, fontWeight: "bold", color: "white", textAlign: 'center' }}>LOGIN</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ backgroundColor: "green", width: "30%", marginRight: 5 }} onPress={() => register(phone,nrlmid,unique_device_id)}>
